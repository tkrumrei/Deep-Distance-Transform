...
def cellpose_eval(model_path, test_path, test_path_2, diam_labels, model_name):
...
def cellpose_train(train_path, test_path, test_path_2, model_type, model_name):
    ...
    cellpose_eval(train_path, test_path, test_path_2, diam_labels, model_name)
...
# Testis Dataset
cellpose_train(f"{palma_path}/Testis/Fold_1/", f"{palma_path}/Testis/Test_Cellpose/", f"{palma_path}/Testis/Test_Testis/", "cyto", "Cellpose_Testis_Fold_1_Model")
cellpose_train(f"{palma_path}/Testis/Fold_2/", f"{palma_path}/Testis/Test_Cellpose/", f"{palma_path}/Testis/Test_Testis/", "cyto", "Cellpose_Testis_Fold_2_Model")
cellpose_train(f"{palma_path}/Testis/Fold_3/", f"{palma_path}/Testis/Test_Cellpose/", f"{palma_path}/Testis/Test_Testis/", "cyto", "Cellpose_Testis_Fold_3_Model")
cellpose_train(f"{palma_path}/Testis/Fold_4/", f"{palma_path}/Testis/Test_Cellpose/", f"{palma_path}/Testis/Test_Testis/", "cyto", "Cellpose_Testis_Fold_4_Model")
cellpose_train(f"{palma_path}/Testis/Fold_5/", f"{palma_path}/Testis/Test_Cellpose/", f"{palma_path}/Testis/Test_Testis/", "cyto", "Cellpose_Testis_Fold_5_Model")
# Mix Dataset
